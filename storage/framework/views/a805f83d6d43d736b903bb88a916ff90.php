...
<section class="content">
                ...
                <div class="box">
                    ...
                    <button style="background:#1c8f4f; color:#fff"><a href="<?php echo e(route('invoice.create')); ?>">Add</a></button>
        <table width=80% border=1>
            ...
            <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($rec->amount); ?></td>
                    
                    <td>
                    
                        <?php if($rec->status == 0): ?>
                          Unpaid
                        <?php elseif($rec->status == 1): ?>
                          Paid
                        <?php else: ?>
                            Cancelled
                        <?php endif; ?>
                    ...
                    <td>
                        ...
                        <button><a  href="<?php echo e(route('invoice.edit',$rec->id)); ?>">Edit </a> </button>
...
<?php echo $__env->make('auth.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\projects\php-machine-test\resources\views/invoice-list.blade.php ENDPATH**/ ?>