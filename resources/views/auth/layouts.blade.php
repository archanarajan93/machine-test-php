...
<ul id="adminmenu">
	...
	<a href="{{ route('list')}}" class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-media" aria-haspopup="true"><div class="wp-menu-arrow"><div></div></div><div class="wp-menu-image dashicons-before dashicons-admin-media"><br>
	</div><div class="wp-menu-name">Customer</div></a>
	</li>
	<li class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-page" id="menu-pages">
	<a href="{{route('invoice.list')}}" class="wp-has-submenu wp-not-current-submenu menu-top menu-icon-page" aria-haspopup="true"><div class="wp-menu-arrow"><div></div></div><div class="wp-menu-image dashicons-before dashicons-admin-page"><br></div><div class="wp-menu-name">Invoice</div></a>
	</li>
...
<div id="wpcontent">
		...
		<li id="wp-admin-bar-my-account" class="menupop with-avatar" onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();"><a class="ab-item" aria-haspopup="true" href="{{ route('logout') }} ">{{ Auth::user()->name }}<span>{{" "}}</span> <div class="display-name"> Logout</div>
		...
		<li id="wp-admin-bar-logout"><a class="ab-item" href="{{ route('logout') }}">Log Out</a>		</li></ul></div>		</li>
		</ul>			</div>
